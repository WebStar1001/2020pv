    ...
    <div>
        <section class="container main-container">
            ...
            <div class="d-flex justify-content-between pagination-row"  v-if="total > 0">
                ...
                <div>Showing {{ query.offset + 1 }} to {{ (query.offset + query.limit) <= total ? (query.offset + query.limit) : total }} of {{ total }}</div>
            </div>
            <div v-if="total === 0">
                Not Found
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            toggleFiltersEnabled() {
                ...
                localStorage.setItem('filtersEnabled', this.filtersEnabled);
            },
