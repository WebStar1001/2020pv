...
const actions = {
    storeData({ commit, state, dispatch }) {
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/change-password', params)
                .then(response => {
                    commit('resetState')
                    resolve()
                })
    ...
    updatePassword({ commit, state, dispatch }, id) {
        commit('setLoading', true);
        dispatch('Alert/resetState', null, { root: true });
        ...
        return new Promise((resolve, reject) => {
            ...
            axios.post('/users/' + id + '/change-password', params)
                .then(response => {
                    commit('resetState');
                    resolve()
                })
    ...
    sendResetPasswordLink({ commit, state, dispatch }, id) {
        return new Promise((resolve, reject) => {
